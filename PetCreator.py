...
class PetCreator:
    ...
    def __init__(self):
        ...
        labelTitle = Label(window, text = "Pet Creator")
        ...
        labelNotes = Label(frame3, text = "Enter pet instructions from owner.")
    ...
    def open(self):
        ...
        self.text.insert(1.0, lineList[4].strip())
